...
plot '2Dvpt_quench_vst_T_0.99_0.1_lmax10_dl0.001_tmax100_dt3.5e-07_BC1.dat' using 2:10 with linespoints title " calculated = d(ln {/Symbol-Oblique r})/d(ln {/Times-Italic t}) ", \
     '2Dvpt_quench_vst_T_0.99_0.1_lmax10_dl0.001_tmax100_dt3.5e-07_BC1.dat' using 2:12 with linespoints title " theory = -zscale/z "
