#filename: plot_vlt_FPquench_vst_T_0.85_0.1_P_00.050_lmax1_dl0.0008_tmax10000_dt01e-09_RhosRhoVst.gnu
reset
set terminal postscript color eps enhanced
set output 'plot_vlt_FPquench_vst_T_0.85_0.1_P_00.050_lmax1_dl0.0008_tmax10000_dt01e-09_RhosRhoVst.ps'
#set size 1.0,1.1

set title "^4He Superfluid Fraction {/Symbol-Oblique r}_s/{/Symbol-Oblique r} vs Time {/Times-Italic t}/{/Times-Italic t}_0"
...
plot 'vlt_FPquench_vst_T_0.85_0.1_P_00.050_lmax1_dl0.0008_tmax10000_dt01e-09.dat' using 2:8 with linespoints title "Kr/K0, 0.85 to 0.10", \
     'vlt_FPquench_vst_T_0.85_0.1_P_00.050_lmax1_dl0.0008_tmax10000_dt01e-09.dat' using 2:7 with linespoints title "K/K0, 0.85 to 0.10"

#     '2DKT_FPquench_vst_T_1_0.1_lmax10_dl0.008_tmax10000_dt01e-05.dat' using 2:7 with linespoints title "1.00 to 0.10", \
