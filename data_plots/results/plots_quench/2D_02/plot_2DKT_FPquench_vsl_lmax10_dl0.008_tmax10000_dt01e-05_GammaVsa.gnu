...
plot '2DKT_FPquench_vsl_T_0.95_0.85_lmax10_dl0.008_tmax10000_dt01e-05.dat' using 3:6 with linespoints title " 0.95 to 0.85 of Tc ", \
     ...
     'tgammaq2.txt' using 1:3 with linespoints title " 0.999 to 0.95 of Tc ", \
     '2DKT_FPquench_v2_vsl_T_0.999_0.95_lmax10_dl0.008_tmax10000_dt01e-05.dat' using 3:6 with linespoints title " 0.999 to 0.95 of Tc ", \
     '2DKT_FPquench_v2c_vsl_T_0.999_0.95_lmax10_dl0.008_tmax10000_dt01e-05.dat' using 3:6 with linespoints title " 0.999 to 0.95 of Tc "

#     '2DKT_FPquench_v2b_vsl_T_0.999_0.95_lmax10_dl0.008_tmax10000_dt01e-05.dat' using 3:6 with linespoints title " 0.999 to 0.95 of Tc "
#     '2Dquench_ProbDensG.dat' using 1:3 with linespoints title "not 0.999 to 0.95 of Tc "
# tgammaq2.txt is from 2DKT_FPquench_Chu.c
# 2Dquench_simple_ProbDensG.dat is screwed up
#
