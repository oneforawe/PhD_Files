...
print "filename: fit_vlt_HeatCap_P_DK0_5e-07_i47_CpVsTv_PowForm.par\n\n", \
      "c","\t","d","\t","(in c_P = c*(1-T/T_lambda)**0.0150649 + d)","\n", \
      c1,"\t",d1,"\n", \
      c2,"\t",d2,"\n", \
      c3,"\t",d3,"\n", \
      c4,"\t",d4,"\n", \
      ...
      c6,"\t",d6,"\n", \
      c7,"\t",d7,"\n\n\n\n", \
      "If you want to plot the fits in gnuplot (with plot_vlt_HeatCap_P_DK0_5e-07_i47_CpVsTv_AhlersCompare.gnu), use this:\n", \
