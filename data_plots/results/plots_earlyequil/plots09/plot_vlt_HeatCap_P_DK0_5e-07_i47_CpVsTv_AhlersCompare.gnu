...
plot 'vlt_HeatCap_P_00.050_DK0_5e-07_i47.dat' using 2:(-1-$9) with linespoints notitle, \
     'vlt_HeatCap_P_00.050_DK0_5e-07_i47.dat' using 2:9 with linespoints title " {/Times-Italic P} = {/Times-Italic P}_{sv} = 0.050 bar ({/Times-Italic T}_{/Symbol-Oblique l} = 2.172 K) ", \
     ...
     'vlt_HeatCap_P_15.031_DK0_5e-07_i47.dat' using 2:9 with linespoints title " {/Times-Italic P} = 15.031 bar ({/Times-Italic T}_{/Symbol-Oblique l} = 1.998 K) ", \
     'vlt_HeatCap_P_18.180_DK0_5e-07_i47.dat' using 2:9 with linespoints title " {/Times-Italic P} = 18.180 bar ({/Times-Italic T}_{/Symbol-Oblique l} = 1.954 K) ", \
     'vlt_HeatCap_P_25.868_DK0_5e-07_i47.dat' using 2:9 with linespoints title " {/Times-Italic P} = 25.868 bar ({/Times-Italic T}_{/Symbol-Oblique l} = 1.836 K) ", \
...
#     'vlt_HeatCap_P_22.533_DK0_5e-07_i47.dat' using 2:9 with linespoints title " {/Times-Italic P} = 22.533 bar ({/Times-Italic T}_{/Symbol-Oblique l} = 1.889 K) ", \
