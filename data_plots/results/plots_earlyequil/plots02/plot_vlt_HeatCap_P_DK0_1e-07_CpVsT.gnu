#filename: plot_vlt_HeatCap_P_DK0_1e-07_CpVsT.gnu
reset
set terminal postscript color eps enhanced
set output 'plot_vlt_HeatCap_P_DK0_1e-07_CpVsT.ps'

set title "^4He Molar Specific Heat Capacity at Constant Pressure {/Times-Italic c_P} \n vs Unitless Temperature {/Times-Italic t = T / T}_{/Symbol-Oblique l}"

set ylabel "{/Times-Italic c_P} (J mol^{-1} K^{-1})"
set xlabel "{/Times-Italic t = T / T}_{/Symbol-Oblique l}{/Times-Italic (P)} (unitless)"
#set logscale x
set xrange [0.98:1.02]
set yrange [0:350]
set grid
set key inside right top box width -9 spacing 1.2 title "Calculated from \n {/CM-Typewriter vlt\\_HeatCap\\_P.c}"
set rmargin 2
