#filename: plot_vlt_HeatCap_P_DK0_1e-07_CapVsTv_log.gnu
reset
set terminal postscript color eps enhanced
set output 'plot_vlt_HeatCap_P_DK0_1e-07_CapVsTv_log.ps'
set size 1.1,1
...
#set yrange [0:0.01]
set grid
set key outside right top box width -4 spacing 1.2 title " Calculated from \n {/CM-Typewriter vlt\\_HeatCap\\_P.c}"
set rmargin 13
