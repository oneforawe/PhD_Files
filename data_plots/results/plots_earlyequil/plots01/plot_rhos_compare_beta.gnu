#filename: plot_rhos_compare_beta.gnu
reset
set terminal png
set output 'plot_rhos_compare_beta.png'
...
plot 'Donnelly_rhos.dat' using 1:2 with points title " Donnelly data  ", \
     ...
     'ring3_Dexp100_C_beta.dat' using (2.1768*$1):9 with linespoints title " new calculation "
