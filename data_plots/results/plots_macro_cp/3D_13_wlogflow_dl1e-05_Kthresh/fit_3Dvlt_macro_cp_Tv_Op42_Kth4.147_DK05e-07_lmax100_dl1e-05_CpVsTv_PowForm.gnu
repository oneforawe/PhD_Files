#filename: fit_3Dvlt_macro_cp_Tv_Op42_Kth4.147_DK05e-07_lmax100_dl1e-05_CpVsTv_PowForm.gnu
reset
#FIT_LIMIT = 1e-5
...
fit [1e-3:5e-6] f1(x) '3Dvlt_macro_cp_Tv_Op42_Kth4.147_P00.050_DK05e-07_lmax100_dl1e-05.dat' using 4:14 via c1,d1
fit [1e-3:5e-6] f2(x) '3Dvlt_macro_cp_Tv_Op42_Kth4.147_P01.646_DK05e-07_lmax100_dl1e-05.dat' using 4:14 via c2,d2
fit [1e-3:5e-6] f3(x) '3Dvlt_macro_cp_Tv_Op42_Kth4.147_P07.328_DK05e-07_lmax100_dl1e-05.dat' using 4:14 via c3,d3
fit [1e-3:5e-6] f4(x) '3Dvlt_macro_cp_Tv_Op42_Kth4.147_P15.031_DK05e-07_lmax100_dl1e-05.dat' using 4:14 via c4,d4
fit [1e-3:5e-6] f5(x) '3Dvlt_macro_cp_Tv_Op42_Kth4.147_P18.180_DK05e-07_lmax100_dl1e-05.dat' using 4:14 via c5,d5
fit [1e-3:5e-6] f6(x) '3Dvlt_macro_cp_Tv_Op42_Kth4.147_P22.533_DK05e-07_lmax100_dl1e-05.dat' using 4:14 via c6,d6
fit [1e-3:5e-6] f7(x) '3Dvlt_macro_cp_Tv_Op42_Kth4.147_P25.868_DK05e-07_lmax100_dl1e-05.dat' using 4:14 via c7,d7

set print 'fit_3Dvlt_macro_cp_Tv_Op42_Kth4.147_DK05e-07_lmax100_dl1e-05_CpVsTv_PowForm.par'
print "filename: fit_3Dvlt_macro_cp_Tv_Op42_Kth4.147_DK05e-07_lmax100_dl1e-05_CpVsTv_PowForm.par\n\n", \
      "c","\t","d","\t","(in c_P = c*(1-T/T_lambda)**(negalpha) + d)  where negalpha = 0.015065056839536073","\n", \
      c1,"\t",d1,"\n", \
      c2,"\t",d2,"\n", \
      c3,"\t",d3,"\n", \
      c4,"\t",d4,"\n", \
