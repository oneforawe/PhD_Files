#filename: thesis_plot_3Dvlt_K0cFind3_Plot_Ky_a.gnu
reset
set terminal postscript color eps enhanced
set output 'thesis_plot_3Dvlt_K0cFind3_Plot_Ky_a.ps'
set size 0.85,0.85
##set size 1.00,0.85
#set size 0.85,1.20
...
set xrange [Kstar-2e-4:Kstar+2e-4]
set yrange [ystar-5e-5:ystar+5e-5]

#set xrange [Kstar-3e-5:Kstar+3e-5]
#set yrange [ystar-5e-6:ystar+5e-6]

###set xrange [Kstar-3e-6:Kstar+3e-6]
###set yrange [ystar-5e-7:ystar+5e-7]
####set xrange [Kstar-1.1e-6:Kstar+1.1e-6]
####set yrange [ystar-4e-7:ystar+4e-7]

#set xrange [Kstar-3e-7:Kstar+3e-7]
#set yrange [ystar-5e-8:ystar+5e-8]

#set xrange [Kstar-3e-14:Kstar+3e-14]
#set yrange [ystar-5e-15:ystar+5e-15]
#set xrange [Kstar-3e-15:Kstar+3e-15]
#set yrange [ystar-5e-16:ystar+5e-16]
#set xrange [Kstar-3e-16:Kstar+3e-16]
#set yrange [ystar-5e-17:ystar+5e-17]
...
#set arrow from 0.38735,0.06244 to 0.38740,0.06244 ls 1 lc rgb "black" lw 2 head

# horizontal arrows
#set arrow from 0.3875048,0.06246    to 0.3875047,0.06246    ls 1 lc rgb "red" lw 1 head size 0.00001,15
#set arrow from 0.3875048,0.0624399  to 0.3875047,0.0624399  ls 1 lc rgb "red" lw 1 head size 0.00001,15
#set arrow from 0.3875147,0.06240009 to 0.3875148,0.06240009 ls 1 lc rgb "red" lw 1 head size 0.00001,15
#set arrow from 0.3875147,0.06238    to 0.3875148,0.06238    ls 1 lc rgb "red" lw 1 head size 0.00001,15

set arrow from Kstar,0.06246    to Kstar-0.0000057,0.06246    ls 1 lc rgb "black" lw 1 head size 0.00001,15
set arrow from Kstar,0.0624399  to Kstar-0.0000057,0.0624399  ls 1 lc rgb "black" lw 1 head size 0.00001,15
set arrow from Kstar,0.06240014 to Kstar+0.0000057,0.06240014 ls 1 lc rgb "black" lw 1 head size 0.00001,15
set arrow from Kstar,0.06238003 to Kstar+0.0000057,0.06238003 ls 1 lc rgb "black" lw 1 head size 0.00001,15

# vertical arrows
set arrow from 0.38737509,1.0/(A3*0.38737509)  to 0.38737509,1.0/(A3*0.38737509)+0.0000019  ls 1 lc rgb "black" lw 1 head size 0.00001,15
set arrow from 0.38745850,1.0/(A3*0.38745850)  to 0.38745850,1.0/(A3*0.38745850)+0.0000019  ls 1 lc rgb "black" lw 1 head size 0.00001,15
set arrow from 0.38756832,1.0/(A3*0.38756832)  to 0.38756832,1.0/(A3*0.38756832)-0.0000019  ls 1 lc rgb "black" lw 1 head size 0.00001,15
set arrow from 0.38765000,1.0/(A3*0.38765000)  to 0.38765000,1.0/(A3*0.38765000)-0.0000019  ls 1 lc rgb "black" lw 1 head size 0.00001,15

# attract/repel arrows
set arrow from 0.38750818971234341,0.062421005457601902   to 0.38748000856317338,0.06243230451800777   ls 1 lc rgb "magenta" lw 1 head size 0.00001,15
set arrow from 0.38750818971234341,0.062421005457601902   to 0.38754003201807435,0.062408241384222685  ls 1 lc rgb "green"   lw 1 head size 0.00001,15
set arrow from 0.38765807158374799,0.062456947610102315   to 0.38753447371538713,0.062427308774956058  ls 1 lc rgb "red"     lw 1 head size 0.00001,15
set arrow from 0.38747897808419079,0.062413999898555221   to 0.38748004838461947,0.062414256582266112  ls 1 lc rgb "blue"    lw 1 head size 0.00001,15

#set arrow from 0.38747897808419079,0.062413999898555221   to 0.38748501334075913,0.062415447294932126  ls 1 lc rgb "blue"    lw 1 head size 0.00001,15
show arrow


## Vertical Line ##
set arrow from Kstar,ystar-5e-5  to Kstar,ystar+5e-5  ls 0 nohead
...
#'3Dvlt_K0cFind3_Plot_Op3363_K0.005_y-0.001_step4000000.dat' using 2:3 with points title "(ds limtd)", \
#     '3Dvlt_K0cFind3_Plot_Op3363_K0.010_y-0.001_step4000000.dat' using 2:3 with points title "(ds limtd)", \
#     '3Dvlt_K0cFind3_Plot_Op3363_K0.040_y-0.001_step4000000.dat' using 2:3 with points title "(ds limtd)", \
#     '3Dvlt_K0cFind3_Plot_Op3363_K0.050_y-0.001_step4000000.dat' using 2:3 with points title "(ds limtd)", \
#     '3Dvlt_K0cFind3_Plot_Op3363_K0.070_y-0.001_step4000000.dat' using 2:3 with points title "(ds limtd)", \
#     '3Dvlt_K0cFind3_Plot_Op3363_K0.100_y-0.001_step4000000.dat' using 2:3 with points title "(ds limtd)", \
