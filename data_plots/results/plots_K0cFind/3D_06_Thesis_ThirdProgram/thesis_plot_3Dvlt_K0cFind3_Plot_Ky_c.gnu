#filename: thesis_plot_3Dvlt_K0cFind3_Plot_Ky_c.gnu
reset
set terminal postscript color eps enhanced
set output 'thesis_plot_3Dvlt_K0cFind3_Plot_Ky_c.ps'
set size 0.85,0.85
##set size 1.00,0.85
#set size 0.85,1.20
...
#set xrange [Kstar-3e-4:Kstar+3e-4]
...
plot '3Dvlt_K0cFind3_Plot_Op3341_K0.400_y0.025_step150000.dat'   using 2:3 with lines ls 2 lc rgb "black" title "(dl const)", \
...
#     "<echo Kstar ystar" with points lc rgb "black" title " Fixed pts ", \
