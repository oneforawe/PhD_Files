#filename: thesis_plot_3Dvlt_K0cFind3_Plot_Ky_b.gnu
reset
set terminal postscript color eps enhanced
set output 'thesis_plot_3Dvlt_K0cFind3_Plot_Ky_b.ps'
set size 0.85,0.85
##set size 1.00,0.85
#set size 0.85,1.20
...
## Vertical Line ##
#set arrow from Kstar,ystar-5e-6  to Kstar,ystar+5e-6  ls 0 nohead
