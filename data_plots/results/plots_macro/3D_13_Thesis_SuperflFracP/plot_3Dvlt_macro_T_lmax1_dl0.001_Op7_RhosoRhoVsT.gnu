#filename: plot_3Dvlt_macro_T_lmax1_dl0.001_Op7_RhosoRhoVsT.gnu
reset
set terminal postscript color eps enhanced
set output 'plot_3Dvlt_macro_T_lmax1_dl0.001_Op7_RhosoRhoVsT.ps'
set size 0.85,0.85
...
plot '3Dvlt_macro_T_Cc1.11_lmax1_dl0.001_Op7.dat' using 1:6 with lines title "  0.05 bar  (2.172 K) ", \
     '3Dvlt_macro_T_Cc0.91_lmax1_dl0.001_Op7.dat' using 1:6 with lines title "  7.27 bar  (2.096 K) ", \
     '3Dvlt_macro_T_Cc0.79_lmax1_dl0.001_Op7.dat' using 1:6 with lines title " 12.13 bar  (2.036 K) ", \
     '3Dvlt_macro_T_Cc0.67_lmax1_dl0.001_Op7.dat' using 1:6 with lines title " 18.06 bar  (1.956 K) ", \
     '3Dvlt_macro_T_Cc0.56_lmax1_dl0.001_Op7.dat' using 1:6 with lines title " 24.10 bar  (1.865 K) ", \
     '3Dvlt_macro_T_Cc0.48_lmax1_dl0.001_Op7.dat' using 1:6 with lines title " 29.09 bar  (1.782 K) ", \
