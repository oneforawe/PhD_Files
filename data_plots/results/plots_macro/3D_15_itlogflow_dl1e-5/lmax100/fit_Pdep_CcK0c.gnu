#filename: fit_Pdep_CcK0c.gnu
reset

fCc(x)  = C00 + C01*x + C02*x**2 + C03*x**3 + C04*x**4 + C05*x**5 + C06*x**6 + C07*x**7 + C08*x**8 + C09*x**9 + C10*x**10
fit fCc(x) 'Pdep_CcK0c.dat' using 4:1 via C00,C01,C02,C03,C04,C05,C06,C07,C08,C09,C10

fK0c(x)  = k00 + k01*x + k02*x**2 + k03*x**3 + k04*x**4 + k05*x**5 + k06*x**6 + k07*x**7 + k08*x**8 + k09*x**9 + k10*x**10
fit fK0c(x) 'Pdep_CcK0c.dat' using 4:2 via k00,k01,k02,k03,k04,k05,k06,k07,k08,k09,k10

set print 'fit_Pdep_CcK0c_results.dat'
print "#filename: fit_Pdep_Cc_K0c_results.dat\n", \
      "#source: fit_Pdep_CcK0c.gnu\n\n", \
      "Cc(P) fit parameters\n", \
      C00,"\n", \
      C01,"\n", \
      C02,"\n", \
      ...
      k09,"\n", \
      k10,"\n\n\n", \
      "If you want to plot the fit in gnuplot (with plot_fit_Pdep_CcK0c.gnu), use this:\n", \
      ...
      "24.10\t",fCc(24.10),"\n", \
      "29.09\t",fCc(29.09),"\n\n\n", \
      "Place the following in a 3Dvlt_K0cFind_Input.dat file and run 3Dvlt_K0cFind.c to find the K0c:\n\n", \
      "Cc\t","K01\n", \
      fCc(0.050),"\t",2.0,"\n", \
      fCc(1.646),"\t",2.0,"\n", \
      fCc(7.328),"\t",2.0,"\n", \
      ...
      fCc(1.0*1.01325),"\t",2.0,"\n", \
      fCc(5.0*1.01325),"\t",2.0,"\n", \
      fCc(10.0*1.01325),"\t",2.0,"\n", \
      fCc(15.0*1.01325),"\t",2.0,"\n", \
      fCc(20.0*1.01325),"\t",2.0,"\n", \
      fCc(24.0*1.01325),"\t",2.0,"\n\n", \
      "Cc\t","K01\n", \
      fCc(0.0*1.01325),"\t",2.0,"\n", \
      fCc(2.5*1.01325),"\t",2.0,"\n", \
      fCc(5.0*1.01325),"\t",2.0,"\n", \
      fCc(7.5*1.01325),"\t",2.0,"\n", \
      fCc(10.0*1.01325),"\t",2.0,"\n", \
      fCc(12.5*1.01325),"\t",2.0,"\n", \
      fCc(15.0*1.01325),"\t",2.0,"\n", \
      fCc(17.5*1.01325),"\t",2.0,"\n", \
      fCc(20.0*1.01325),"\t",2.0,"\n", \
      fCc(22.5*1.01325),"\t",2.0,"\n", \
      fCc(25.0*1.01325),"\t",2.0,"\n\n", \
      "Cc\t","K01\n", \
      fCc(0.05),"\t",2.0,"\n", \
      fCc(7.27),"\t",2.0,"\n", \
      fCc(12.13),"\t",2.0,"\n", \
