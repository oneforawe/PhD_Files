...
plot '2Dvpt_macro_T_lmax83_dl0.001_Op7.dat'  using            1:($5*slope1)         with lines lw 2 notitle, \
     '2Dvpt_macro_T_lmax83_dl0.001_Op7.dat'  using (factor1*$1):($5*slope1*factor1) with lines lw 2 notitle, \
     '2Dvpt_macro_T_lmax83_dl0.001_Op7.dat'  using (factor2*$1):($5*slope1*factor2) with lines lw 2 notitle, \
