#filename: calc_Ferer_XvsP.gnu
reset
set output 'calc_Ferer_XvsP.dat'

# The following values and parameters were taken from
# plot_TheoryVsBrooksDonnelly_U0VsP.gnu
# plot_TheoryVsGlaberson_a0VsP.gnu
# 3Dvlt_macro_cp.c version 9
# and
# (for B', experimental/exp and theoretical/loop)
# HeatCapFits3.dat
# from file:///home/zero/Documents/School/UCLA/Research/Williams/programs/results/plots_macro_cp/3D_09_Thesis/
...
set print 'calc_Ferer_XvsP.dat'
print "filename: calc_Ferer_XvsP.dat\n\n", \
...
set print 'calc_Ferer_XvsP_4ThesisTable.dat'
print "filename: calc_Ferer_XvsP_4ThesisTable.dat\n", \
