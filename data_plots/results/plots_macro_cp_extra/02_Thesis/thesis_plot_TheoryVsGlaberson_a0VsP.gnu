...
#set yrange [0:0.008]
#set grid
set key inside top left box width -11 height 0.5 spacing 1.4
set rmargin 2
...
plot 'Glaberson_a0VsP.dat' using ($1*(300./438)*(1./14.5037738007)):(1+$2*(0.3/350)):(1+$3*(0.3/350)):(1+$4*(0.3/350)) with yerrorbars pt 4 title " ({/Times-Italic T} = 0.3 K) Glaberson's data ", \
     ...
     '3Dvlt_macro_cp_extra_BareValues_T0.3_Output30.dat' using 1:13 with points linestyle 1 lc rgb "black" notitle, \
     '3Dvlt_macro_cp_extra_BareValues_Tc_Output30.dat'   using 1:13 with points linestyle 1 lc rgb "black" notitle
