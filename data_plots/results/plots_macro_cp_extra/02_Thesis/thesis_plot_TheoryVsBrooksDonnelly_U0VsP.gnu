...
plot 'BrooksDonnelly_RotonEnergyVsPressTc.dat' using 2:4 title " Roton data taken/extrapolated from Brooks, Donnelly" with linespoints, \
     U0ok(x) title " Loop theory fit ", \
     '3Dvlt_macro_cp_extra_BareValues_T0.3_Output30.dat' using 1:11 with points linestyle 1 lc rgb "black" notitle
