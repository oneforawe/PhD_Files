...
plot 'Glaberson_a0VsP.dat' using ($1*(300./438)*(1./14.5037738007)):(1+$2*(0.3/350)):(1+$3*(0.3/350)):(1+$4*(0.3/350)) with yerrorbars pt 4 title " Glaberson's data ", \
     '3Dvlt_macro_cp_extra_BareValues_T0.3_OutputAll.dat' using 1:13 with linespoints title " VLT calculations (T = 0.3 K) ", \
     '3Dvlt_macro_cp_extra_BareValues_Tc_OutputAll.dat' using 1:13 with linespoints title " VLT calculations (T = Tc) ", \
