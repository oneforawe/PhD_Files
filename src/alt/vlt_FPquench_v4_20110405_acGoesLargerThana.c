...
/* VERSION: 4 (2011 Mar 28 - 2011 Apr 05)
...
main(){
	...
	//	}
		...
		for(s2=1; s2<=1; s2++){
			switch(s2){
				case 1: iTfrac = 1.00; qTfrac = 0.999; break;
...
//			printf("\n\n\n \t\t newlpts = %i\n\n\n\n", newlpts);
			...
			fprintf(outfile2,"%ld\t%g\t%g\t%g\t%g\t%g\t%g\t%g\t%g\t%g\n", n_t, t, iTfrac, 1-iTfrac, l[newlpts-1], K[newlpts-1], K[newlpts-1]/K0, Kr[newlpts-1]/K0, G[newlpts-1], vldens);
			fflush(outfile2);
...
//				dt = dt0 + Dt*(1-exp(-t));  // added
				...
				vlintegral += G[0]*exp(3*l[0])*dl;
				vlintegral += G[newlpts-1]*exp(3*l[newlpts-1])*dl;
				vldens = 4*PI*a03*vlintegral;
...
//				printf("\n\n\n \t\t newlpts = %i\n\n\n\n", newlpts);
				...
				if(t>ttrig){
					fprintf(outfile2,"%ld\t%g\t%g\t%g\t%g\t%g\t%g\t%g\t%g\t%g\n", n_t, t, qTfrac, 1-qTfrac, l[newlpts-1], K[newlpts-1], K[newlpts-1]/K0, Kr[newlpts-1]/K0, G[newlpts-1], vldens);
					fflush(outfile2);
