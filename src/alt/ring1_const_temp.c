...
main(){
	...
	outfile = fopen("3D_Kversusl_B_i59.dat","w");  //  "ring1_const_temp.out"
	...
	// for(i=0; i<60; i++){
		...
		while(estimated.l<Dexp && estimated.thrmv[0]<5.0){
			...
			estimated = derk(IN ringrecrel, INOUT estimated, IN 0.0001, IN N);  // Dl=0.0001, n=3
