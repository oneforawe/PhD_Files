...
/* VERSION: 9 (2011 Sep 02 - 2012 Jul 29)
...
//			if(TempLabelOp==0)  asprintf(&filename, "3Dvlt_constT_%g_Cc%3.2f_lmax%g_dl%g_Op%i.dat",  Tfrac,Cc,lmax,dl,Op);
			if(TempLabelOp==0)  asprintf(&filename, "3Dvlt_constT_%4.3f_Cc%3.2f_lmax%g_dl%g_Op%i.dat",  Tfrac,Cc,lmax,dl,Op);
...
////			printf(         "%g\t%g\t%g\t%g\t%g\t%g\t%g\t%g\t%g\n", Tfrac, tempv, l[0], K[0], y[0], e[0], K[0]/K0, Kr[0]/K0, G[0]);
