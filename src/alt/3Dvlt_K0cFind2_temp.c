...
const double initialAbsdK    = 1.0e-12;
const double trajectoryAbsdK = 1.0e-4;
const double uncertainty     = 1.0e-6;  // could loop, decreasing dK until within K0c is uncertainty
...
main(){
	...
	outfile = fopen("3Dvlt_K0cFind2_temp_Output2.dat","w");
