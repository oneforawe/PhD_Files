...
/* VERSION: 2 (2011 Jun 16 - 2012 Mar 10)
...
const double lmax     = 23.0;       //  1  //  maximum of the length scale l (potentially approximate)
const int    lsteps   = 23000;      //  1250, 5000, 100000 //  lsteps = lmax/dl = 10/0.0001 = 100,000  (make sure this is divisible by ldatamax)
