...
main(){
	...
	//	}
		...
		for(s2=1; s2<=5; s2++){
			...
			asprintf(&filename1, "3Dvlt_quench_vsl_3_T_%g_%g_P_%06.3f_lmax%g_dl%g_tmax%g_dt0%g.dat", iTfrac, qTfrac, P, lmax, dl, tmax, dt0);
			asprintf(&filename2, "3Dvlt_quench_vst_3_T_%g_%g_P_%06.3f_lmax%g_dl%g_tmax%g_dt0%g.dat", iTfrac, qTfrac, P, lmax, dl, tmax, dt0);
