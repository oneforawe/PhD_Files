...
const double lmax     = 2.0;         //  1  //  maximum of the length scale l (potentially approximate)
...
main(){
	...
	asprintf(&filename1, "2DKT_FPquench_vsl_T_%g_%g_lmax%g_dl%g_tmax%g_dt%g_BC%i.dat", iTfrac, qTfrac, lmax, dl, tmax, dt, BC);
	asprintf(&filename2, "2DKT_FPquench_vst_T_%g_%g_lmax%g_dl%g_tmax%g_dt%g_BC%i.dat", iTfrac, qTfrac, lmax, dl, tmax, dt, BC);
	...
	fprintf(outfile1,"# Parameter values: iTfrac=%g, qTfrac=%g, lmax=%g, lsteps=%i, (dl=%g), lpts=%i, ldatamax=%i, tmax=%g, dt=%g, a0=%g, a02=%g, a04=%g, K0c=%g\n", iTfrac,qTfrac,lmax,lsteps,dl,lpts,ldatamax,tmax,dt,a0,a02,a04,K0c);
	fprintf(outfile2,"# Parameter values: iTfrac=%g, qTfrac=%g, lmax=%g, lsteps=%i, (dl=%g), lpts=%i, ldatamax=%i, tmax=%g, dt=%g, a0=%g, a02=%g, a04=%g, K0c=%g\n", iTfrac,qTfrac,lmax,lsteps,dl,lpts,ldatamax,tmax,dt,a0,a02,a04,K0c);
