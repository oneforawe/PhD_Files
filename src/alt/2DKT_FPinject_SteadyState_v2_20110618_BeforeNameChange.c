...
/* FILENAME: 2DKT_FPinject_SteadyState.c */
...
/* EXT FILES: none */
/* COMPILE NOTES:
   * To compile, type "g++ -lm 2DKT_FPinject_SteadyState.c" without the quotes; then to run, type "./a.out".
...
main(){
	...
	asprintf(&filename1, "2DKT_FPinject_SteadyState_vsl_T_%g_lmax%g_dl%g_linj%g_InjConst%g.dat", iTfrac, lmax, dl, linj, InjConst);
//	asprintf(&filename2, "2DKT_FPinject_SteadyState_vst_T_%g_lmax%g_dl%g_linj%g_InjConst%g_sink.dat", iTfrac, lmax, dl, linj, InjConst);
	outfile1 = fopen(filename1,"w");  //  E.g., "2DKT_FPinject_SteadyState.out"
//	outfile2 = fopen(filename2,"w");  //  E.g., "2DKT_FPinject_SteadyState.out"
	fprintf(outfile1,"# Filename: %s\n", filename1);
//	fprintf(outfile2,"# Filename: %s\n", filename2);
	fprintf(outfile1,"# Source: 2DKT_FPinject_SteadyState.c\n");
//	fprintf(outfile2,"# Source: 2DKT_FPinject_SteadyState.c\n");
